    ...
    return(
        ...
        <div className='container about-us-container'>
            ...
            <div className='about-us-text'>
                ...
                <ul className='about-us-description'>Jesteśmy siłownią działającą na terenie Krościenka nad Dunajcem od 2022 roku.
                    <li> Mamy ponad 13 lat bogatego doświadczenia w spersonalizowanych treningach oraz 14 trenerów na dowiedzenie swoich przekonań!</li>
                    <li>Co tydzień organizujemy regularne zajęcia z yogi, pilatesu, zumby, treningów brzucha oraz całego ciała.
                    </li>
                    <li>Mamy możliwość dostosowania karnetów do wielu przedziałów godzinowych oraz politykę łatwego pauzowania karnetu na rzecz wyjazdów i niespodziewanych planów.
                    </li>
                    <li>Nasz klub fitness oferuje również szerokie wsparcie trenerów personalnych, którzy mogą wspomóc każdego przy podstawowych i bardziej zaawansowanych ćwiczeniach z maszynami, ale również ułożyć plan treningowy w długim terminie.
                    </li>
                    <li>Całą ofertę treningową personalną, grupową oraz karnety tygodniowe, miesięczne i w różnych wariantach godzinowych możesz omówić z nami przez telefon, dograć szczegóły, a my wyślemy Ci całą ofertę mailowo!</li>
                </ul>
            </div>

            <div className='blog-training-container'>
            <h4 className='about-us-title-top'> Nasze Porady Treningowe</h4>
            <h5 className='about-us-title'>1. Dostosuj swój trening do zamierzonego celu</h5>
            <p>Najważniejszym krokiem osób początkujących jest określenie swoich priorytetów treningowych i dopasowanie do nich rutyny treningowej. Może brzmieć to prozaicznie, jednak jak wskazują obserwacje na wielu siłowniach, trenujący nie zawsze są w stanie odpowiedzieć instruktorowi po co właściwie przyszli na siłownię.
            ...
            <h5 className='about-us-title'>3. Opieraj swoje plany treningowe na dobrze znanych Ci ćwiczeniach</h5>
            <p>Plan treningowy powinien opierać się na ćwiczeniach dobrze znanych i opanowanych. Te które są nowością, powinniśmy ćwiczyć i doskonalić. Niepoprawna technika osłabia efektywność treningu, a także powoduje kontuzje.
                Przykładem niech będzie jedno z najważniejszych ćwiczeń siłowych- przysiad. Ludzie nieobeznani z jego prawidłową formą wykazują tendencje m.in. do uciekania kolanami do wewnątrz, co sprawia, że staw kolanowy nie pracuje prawidłowo.
                A mimo wszystko ćwiczenie jest przez nich wykonywane. Inną sprawą jest nauka nowych rzeczy i opanowywanie techniki, co należy do obowiązków każdego ćwiczącego, który nastawia się na efekty. Ten proces z kolei należy przeprowadzić pod okiem trenera personalnego, który będzie w stanie poprawić nas na bieżąco i kontrolować.
            </p>

            <h5 className='about-us-title'>4. Przychodź na siłownię przygotowanym</h5>
            <p>Siłownia wymaga od nas zdecydowania i jasno określonych zamiarów. Ograniczenie czasowe każdego treningu – nie każdy ma cały dzień na trening.
                Przerwy na zastanawianie się czy bezcelowe orbitowanie wokół sprzętu, m.in. powodują obniżenie tętna i możliwości treningowych mięśni.
