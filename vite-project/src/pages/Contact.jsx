...
function MyForm() {
    ...
    return (
        <form className="my-form" onSubmit={handleSubmit}>
            ...
            <label>Podaj swój email do kontaktu:
                <input
                    type="email"
                    name="email"
                    value={inputs.email || ""}
    ...
    return(
        ...
        <div className='contact-container'>
            ...
            <div className='form-box'>
                <p className='form-description'>Jeśli chcesz zostawić nam kontakt do siebie - skorzystaj z formularza, a my prześlemy Ci ofertę!</p>
            <MyForm/>
            </div>
        </div>
    );
