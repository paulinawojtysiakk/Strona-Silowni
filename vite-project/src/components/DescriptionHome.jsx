            ...
            <Box className='' sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <Card  className='desc-home-text-img' sx={{ width: '100%', marginBottom: '15px' }}>
                    ...
                    <CardContent className='desc-home-text'>
                        ...
                        <Typography variant="body2" className='desc-home-info' sx={{ marginTop: '10px' }}>
                            Niezależnie od powodu możesz w dowolnym momencie zawiesić swoje członkostwo w Pieniny Fitness.
                        </Typography>
                        ...
                        <Typography variant="body2" className='desc-home-info' sx={{ marginTop: '10px' }}>
                            Jeśli masz ukończone 16 lat, to na luzie możesz trenować w naszym klubie. Wystarczy, że Twój rodzic lub opiekun prawny wypełni oświadczenie.
                        </Typography>
